...
Begin VB.Form FrmMovCaja 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "FrmMovCaja.frx":0342
      ...
      Begin VB.Frame FmeCuentas 
         ...
         Begin VB.Frame frame3 
            ...
            Begin VB.CommandButton Command 
               DisabledPicture =   "FrmMovCaja.frx":0754
               Enabled         =   0   'False
               Height          =   255
               Index           =   0
               Left            =   3510
               Picture         =   "FrmMovCaja.frx":089E
               Style           =   1  'Graphical
               TabIndex        =   131
               Top             =   45
               Width           =   255
         ...
         Begin VB.Frame Frame5 
            ...
            Begin VB.ComboBox Cmb 
               ...
               Height          =   315
               Index           =   2
               ItemData        =   "FrmMovCaja.frx":0B54
               Left            =   3255
               List            =   "FrmMovCaja.frx":0B56
               Sorted          =   -1  'True
               TabIndex        =   81
            ...
            Begin VB.ComboBox Cmb 
               ...
               Height          =   315
               Index           =   3
               ItemData        =   "FrmMovCaja.frx":0CA2
               Left            =   3255
               List            =   "FrmMovCaja.frx":0CA4
               Sorted          =   -1  'True
               TabIndex        =   78
            ...
            Begin VB.ComboBox Cmb 
               ...
               Height          =   315
               Index           =   4
               ItemData        =   "FrmMovCaja.frx":0CA6
               Left            =   3255
               List            =   "FrmMovCaja.frx":0CA8
               Sorted          =   -1  'True
               TabIndex        =   74
            ...
            Begin VB.ComboBox Cmb 
               ...
               Height          =   315
               Index           =   5
               ItemData        =   "FrmMovCaja.frx":0DF4
               Left            =   30
               List            =   "FrmMovCaja.frx":0E01
               Sorted          =   -1  'True
               TabIndex        =   71
            ...
            Begin VB.ComboBox Cmb 
               ...
               Height          =   315
               Index           =   6
               ItemData        =   "FrmMovCaja.frx":0E26
               Left            =   30
               List            =   "FrmMovCaja.frx":0E33
               Sorted          =   -1  'True
               TabIndex        =   70
            ...
            Begin VB.ComboBox Cmb 
               ...
               Height          =   315
               Index           =   7
               ItemData        =   "FrmMovCaja.frx":0E58
               Left            =   30
               List            =   "FrmMovCaja.frx":0E65
               Sorted          =   -1  'True
               TabIndex        =   69
         ...
         Begin VB.ComboBox Cmb 
            ...
            Height          =   315
            Index           =   0
            ItemData        =   "FrmMovCaja.frx":0EF0
            Left            =   9180
            List            =   "FrmMovCaja.frx":0F03
            Sorted          =   -1  'True
            TabIndex        =   9
         ...
         Begin VB.ComboBox Cmb 
            ...
            Height          =   315
            Index           =   1
            ItemData        =   "FrmMovCaja.frx":0F39
            Left            =   9180
            List            =   "FrmMovCaja.frx":0F43
            Sorted          =   -1  'True
            TabIndex        =   7
   ...
   Begin ComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {0713E8C2-850A-101B-AFC0-4210102A8DA7} 
         ...
         BeginProperty ListImage1 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "FrmMovCaja.frx":145D
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "FrmMovCaja.frx":15DF
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "FrmMovCaja.frx":1761
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "FrmMovCaja.frx":18E3
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "FrmMovCaja.frx":1A65
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "FrmMovCaja.frx":1BE7
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "FrmMovCaja.frx":1D69
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "FrmMovCaja.frx":1EEB
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "FrmMovCaja.frx":206D
            Key             =   ""
         EndProperty
         BeginProperty ListImage10 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "FrmMovCaja.frx":21EF
            Key             =   ""
         EndProperty
         BeginProperty ListImage11 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "FrmMovCaja.frx":2371
            Key             =   ""
         EndProperty
         BeginProperty ListImage12 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "FrmMovCaja.frx":24F3
            Key             =   ""
         EndProperty
      EndProperty
   End
...
'                End If
    ...
    '   -------------------------------
            ...
            '
            cnnConexion.Execute "INSERT INTO TDFDepositos(IDdeposito,Banco,Cuenta," & _
            "Caja,Fecha,Usuario) VALUES ('" & NDep & "','" & Bco & "','" & Cta & _
            "','" & Cja & "','" & fecha & " ','" & gcUsuario & "')"
...
finalizar:
            ...
            Else
                ...
                For Each X In Printers
                    '
                    If X.DeviceName = "Olivetti" Then 'Or X.DriverName = "Epson LX-300" Then
                        Set Printer = X
                        booE = True
                    End If
                    '
...
End Sub
    ...
    '
        ...
        Case 29 'efectivo Bs Fuertes
            If Label16(29) > 0 Then 'SI EL EFECTIVO ES SUPERIOR A CERO
                If Label16(30).Tag = "BS" Then Label16(33) = Label16(30): Label16(31) = CSng(Label16(31)) - CSng(Label16(30))
        ...
        Case 33 'efectivo Bs. viejos
            If Label16(33) > 0 Then 'SI EL EFECTIVO ES SUPERIOR A CERO
                If Label16(30).Tag = "BSF" Then Label16(29) = Label16(30):: Label16(31) = CSng(Label16(31)) - CSng(Label16(30))
                Label16(30) = Label16(33)
                Label16(30).Tag = "BS"
                Label16(31) = Format(CCur(Label16(33) + CCur(Label16(31))), "#,##0.00")
                Label16(33) = "0,00"
            End If
        
        Case 30
            If Label16(30) > 0 Then 'SI EL EFECTIVO ES SUPERIOR A CERO
                If Label16(30).Tag = "BSF" Then Label16(29) = Label16(30) Else Label16(33) = Label16(30)
...
End Sub
    ...
    '
     ...
     '
        ...
        '
                cnnConexion.Execute "INSERT INTO Periodos (IDRecibo,IdPeriodos,CodGasto," _
                & "Descripcion,Monto) VALUES ('" & strRecibo & "','" & strRecibo & "','" & _
                strCodHA & "','HONORARIOS DE ABOGADO','" _
                & curHono & "')"
                curHono = 0
...
'                End If
        ...
        '               Asigna valores a variables------------------------------------------------
                        ...
                        ElseIf strCodigo = strCodAbonoCta And IsNumeric(FlexFacturas.TextMatrix(I, 0)) Then
                            ...
                            strCodigo & "','" & Mes & "','" & CurFac * -1 & "',Date(),Format(Ti" _
...
'                If booCon Then Call Regristra_Pago
        ...
        '      Actualiza la deuda general del propietario
            ...
            ElseIf Dat(5) = strCodCCHeq Then 'Cambio de cheques
                ...
                & "FechaMov,Fpago, Monto, Ndoc, Banco ) Values ('" & strRecibo & "'," & _
        ...
        '
            ...
            '       -------------------------------------
                ...
                If SSTab1.tab = 3 Then
                    ...
                    pReport.OrigenDatos(0) = gcPath & "\sac.mdb"
                    pReport.OrigenDatos(1) = gcPath & "\sac.mdb"
                    pReport.OrigenDatos(2) = gcPath & "\sac.mdb"
...
'                End If
    ...
    Set objRst = ModGeneral.ejecutar_procedure("procNumTransaccion", Date, Dat(3))
...
End Sub
    ...
    Set RstEfectivo = New ADODB.Recordset
        '
    RstCuentas.Open "SELECT Inmueble.CodInm,Inmueble.Ubica FROM Caja " & _
    "INNER JOIN Inmueble ON Caja.CodigoCaja = Inmueble.Caja WHERE " & _
    "Caja.CodigoCaja='" & _
    Dat(7) & "'", cnnConexion, _
    ...
    If Not RstCheques.EOF Then RstCheques.MoveFirst
        ...
        End If
        Label16(33) = Format(RstEfectivo(0) * 1000, "#,##0.00")
        Set RstEfectivo = Nothing
        GridCheques(0).Row = 1
        GridCheques(0).Col = 0
        Call rtnLimpiar_Grid(GridCheques(1))
        ...
        Do
            ...
            If chk.Value = vbUnchecked Then 'imprime el recibo
               ...
               NomInm = Dat(1)
                ...
                , CodInm, NomInm, strRecibo, True, 0, crImpresora)
    ...
    '   -----------------------------------------------------------------------------
            ...
            "CodInmueble, FechaMov, Fpago, Monto, Ndoc, Banco ) Values ('" & _
            strRecibo & "'," & IntTaquilla & ",'" & Dat(0) & _
    ...
    '   -----------------------------------------------------------------------------
        '
            If cmb(0) = "AMBOS" Then
                ...
                & "echaMov, Fpago, Monto, Ndoc, Banco ) Values ('" & strRecibo & "'," & _
                IntTaquilla & ",'" & Dat(0) & "',date(),'EFECTIVO','" & CurEfectivo & "','" _
                & strRecibo & "', '" & strBco & "')"
                Call rtnBitacora("Pago en efectivo....." & Format(CurEfectivo, "#,##0.00"))
...
'            Call FlexDeducciones_RowColChange
    ...
    '-------------------------------------------------------------------------------------------------
    '   Funcion:    FormaPago_Add
    '
    '   Entradas:   Ndoc,Banco,FormaPago,FechaDoc,Monto
    '
    '-------------------------------------------------------------------------------------------------
    Public Sub FormaPago_Add(Caja%, ParamArray FPago())
    '
    Dim objRst As New ADODB.Recordset   'Variables locales
    '
    Set objRst = ModGeneral.ejecutar_procedure("procPagoCuenta", FPago(NDoc), FPago(Banco), FPago(FP))
...
'    adLockOptimistic, adCmdText
    ...
    With objRst
        '
        If objRst("registro") > 0 Then
    '       Actualiza el monto del cheque
            cnnConexion.Execute "UPDATE TdfCheques SET Monto=Monto +'" & FPago(Monto) & "' WHERE" _
            & " Ndoc='" & FPago(NDoc) & "' AND Banco='" & FPago(Banco) & "' AND Fpago='" & _
            FPago(FP) & "'"
            '
...
'            & "v,Fpago,Ndoc, Banco, FechaDoc,Monto,IDDeposito) VALUES ('" & FPago(IDRecibo) & _
'            "'," & Caja & ",'" & FPago(Inmueble) & "',Date(),'" & FPago(FP) & "','" & _
'            FPago(NDoc) & "','" & FPago(Banco) & "','" & FPago(FechaDoc) & "','" & FPago(Monto) _
'            & "','" & FPago(7) & "')"
            '
        End If
        objRst.Close
    ...
    '   Entradas:Ndoc,Banco,FormaPago,FechaDoc,Monto
    '-------------------------------------------------------------------------------------------------
    Public Sub Actualiza_FormaPago(Recibo$)
    '
    'Vairables cocales
...
'    'total chequesbanco venezuela
    ...
    Printer.FontSize = 10
    'efectivo
    Printer.CurrentY = Linea + 120
    Printer.CurrentX = (10000 - Printer.TextWidth(Label16(30)))
    Printer.Print Label16(30)
    'titular
    Printer.CurrentX = 600
    Printer.CurrentY = Linea + 480
    Printer.Print UCase(Titular)
    'fecha
    Printer.CurrentX = 1800
    Printer.CurrentY = Linea + 1100
    Printer.Print fecha
    ...
    End With
    'total
    Printer.CurrentY = 3720
    Printer.CurrentX = (10000 - Printer.TextWidth(Label16(31)))
    Printer.Print Label16(31)
